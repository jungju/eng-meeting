<script>
	...
	const l = [
		...
		// { id: "uni-may", label: "Sentence Group uni May", type: "sentence", group: "JJ" },
		// { id: "uni-june", label: "Sentence Group uni June", type: "sentence", group: "JJ" },
